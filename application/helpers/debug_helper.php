...
function xml_to_array($deXml,$main_heading = '') {
  ...
  function uploadFile($uploadDir, $baseUrl)
            ...
            {  
                if(isset($_FILES['file']['name']))
                {
                    ...
                    {                           
                        ...
                        {
                            $_imageURL = $baseUrl.'/'.$imageName;
                            //$_imageURL = asset_url('img/stores').'/'.$imageName;
                            
                            //$store_data['store_image_url'] = $_imageURL;
                        }
                    }
                }   
            }
    ...
    function getFacebookImage($facebook_id = "")
    {
      //$facebook_id = 545348665;
      $result = "";
      if(is_numeric($facebook_id))
      {
        $url = "http://graph.facebook.com/$facebook_id/picture?type=normal&redirect=false";
        $result = json_decode(doCurl($url),true);
